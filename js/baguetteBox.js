...
!(function (e, t) {
  ...
  var s,
    ...
    i = {},
    a = !1,
    y = /.+\.(gif|jpe?g|png|webp|avif)/i,
    w = {},
    k = [],
    r = null,
    x = function (e) {
      -1 !== e.target.id.indexOf("baguette-img") && M();
    },
    E = function (e) {
        ...
        h = e,
          (function r(e) {
            ...
            (u.style.display = c.style.display = b.buttons ? "" : "none"),
              ...
              b.buttons &&
                ((u.innerHTML = b.leftArrow), (c.innerHTML = b.rightArrow));
            try {
  ...
  function R() {
    var e = "rtl" === document.querySelectorAll("html")[0].getAttribute("dir"),
      t = -o * (e ? -100 : 100) + "%";
    "fadeIn" === b.animation
      ? ((l.style.opacity = 0),
        setTimeout(function () {
        ...
        return (
          ...
          (function a() {
            ...
            (s = J("div")).setAttribute("role", "dialog"),
              ...
              (function n() {
                var e = v.passiveEvents ? { passive: !1 } : null,
      ...
      destroy: function e() {
        !(function n() {
          ...
          W(s, "click", x),
            ...
            W(s, "touchmove", A, e),
            W(s, "touchend", L),
            W(document, "focus", S, !0);
        })(),
          (function t() {
            for (var e in w) w.hasOwnProperty(e) && H(e);
          })(),
          W(document, "keydown", P),
          document
